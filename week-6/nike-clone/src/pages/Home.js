    ...
    <>
      ...
      <MainHeader>
        ...
        <div className='header-middle'>
          <span className={`${searchParams.get('gender') === 'man' ? 'active' : ''}`} onClick={() => handleGender('man')}>Erkek</span>
          <span className={`${searchParams.get('gender') === 'woman' ? 'active' : ''}`} onClick={() => handleGender('woman')}>Kadın</span>
        </div>
